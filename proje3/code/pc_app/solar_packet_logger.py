#!/usr/bin/env python3
"""Parse and log proje3 shared telemetry packet v1 from UART."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Parse proje3 shared packet v1 telemetry from UART.")
    ...
    parser.add_argument("--log", type=Path, default=Path("proje3/data/solar_packet_v1_log.csv"))

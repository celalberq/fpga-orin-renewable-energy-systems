## Nexys Video constraints for the panel plus four-KY-018 test.
## Top module: solar_ldr_uart_top
## Vivado part code: xc7a200tsbg484-1
##
## MCP3208 on Pmod JB:
##   JB1 adc_cs_n, JB2 adc_mosi, JB3 adc_miso, JB4 adc_sclk
## Power the MCP3208 and KY-018 modules from Pmod 3.3V and GND.
## Never drive an FPGA, Pmod, or MCP3208 input above 3.3V.

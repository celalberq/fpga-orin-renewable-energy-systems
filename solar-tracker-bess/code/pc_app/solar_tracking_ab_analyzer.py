...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out", type=Path, default=Path("solar-tracker-bess/data/solar_tracking_ab_summary.txt"))
    parser.add_argument("--csv-out", type=Path, default=Path("solar-tracker-bess/data/solar_tracking_ab_metrics.csv"))

...
flowchart LR
    ...
    UDP --> COMM["FPGA Digital Communications CRC/QPSK/OFDM bridge"]
    COMM --> DASH["Network Telemetry Dashboard live dashboard + CSV logger"]
```

## Ownership

```text
Solar Tracker and BESS: sensing, tracking, servo actuation, panel/BESS telemetry, protection state
FPGA Digital Communications: CRC framing, QPSK/OFDM profile, FPGA communication pipeline proof
Network Telemetry Dashboard: UDP transport, validation, sequence-gap monitoring, dashboard, CSV logs
```

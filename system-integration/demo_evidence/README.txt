...
through a fpga-digital-communications CRC/QPSK/OFDM communication bridge to the network-telemetry-dashboard dashboard. A
...
```text
solar-tracker-bess Nexys/MCP3208 LDR and panel sensing / Orin tracker / PCA9685 servos
  + INA226 real BESS voltage, signed current, and signed power
  -> UDP JSON to PC port 5013
  -> fpga-digital-communications tracker_udp_comm_bridge.py
  -> compact CRC frame + QPSK/OFDM metadata
  -> forwarded UDP JSON to PC port 5011
  -> network-telemetry-dashboard live dashboard
```
...
```text
system-integration/demo_evidence/video/tracker_subsystem_integrated_demo_2026-08-10.mp4
system-integration/demo_evidence/video/unified_tracker_bess_integrated_demo_2026-08-11_edited.mp4
system-integration/demo_evidence/video/unified_tracker_bess_bidirectional_final_demo_2026-08-11.mp4
system-integration/demo_evidence/video/README.txt
system-integration/demo_evidence/final_report/fpga_orin_renewable_energy_systems_final_report_2026_08_11.docx
system-integration/demo_evidence/final_report/fpga_orin_renewable_energy_systems_final_report_2026_08_11.pdf
system-integration/demo_evidence/final_presentation/fpga_orin_renewable_energy_systems_final_presentation_2026_08_11.pptx
system-integration/demo_evidence/bess_bidirectional_demo_runbook.txt
system-integration/demo_evidence/one_page_project_report_2026_08_11.txt
system-integration/demo_evidence/final_system_architecture_2026_08_11.md
system-integration/reports/tracker_system_evidence_summary.txt
system-integration/reports/tracker_system_evidence_metrics.csv
system-integration/reports/tracker_error_deg.svg
system-integration/reports/tracker_power_mw.svg
system-integration/reports/tracker_angles_deg.svg
system-integration/reports/comm_profile_bar.svg
network-telemetry-dashboard/data/solar_reliability_bridge_evidence_summary.txt

fpga-digital-communications/docs/board_test_10_tracker_frame_qpsk_ofdm_batch.txt
fpga-digital-communications/docs/comm_test_07_tracker_udp_comm_bridge.txt
network-telemetry-dashboard/docs/network_test_08_tracker_bridge_dashboard_status.txt
network-telemetry-dashboard/docs/network_test_09_tracker_bridge_reliability_warning_recovery.txt
network-telemetry-dashboard/docs/network_test_10_camera_tracker_dashboard.txt
solar-tracker-bess/docs/board_test_11_software_tracker_udp.txt
solar-tracker-bess/docs/board_test_12_servo_tracker_udp.txt
solar-tracker-bess/docs/board_test_13_mounted_panel_integrated_demo.txt
solar-tracker-bess/docs/board_test_14_camera_light_tracker_udp.txt
solar-tracker-bess/docs/board_test_16_fixed_vs_pan_tracking_power.txt
solar-tracker-bess/docs/board_test_20_ldr_tracker_udp_dashboard.txt
solar-tracker-bess/docs/board_test_21_ldr_shading_fault_detection.txt
solar-tracker-bess/docs/board_test_22_real_bess_ina226_discharge.txt
solar-tracker-bess/docs/board_test_23_real_bess_charge_udp_dashboard.txt
solar-tracker-bess/docs/board_test_24_unified_tracker_bess_discharge.txt
solar-tracker-bess/docs/board_test_25_unified_tracker_bess_bidirectional_demo.txt
...
network-telemetry-dashboard:
  ...
  that injects packet drops/corruption after the fpga-digital-communications bridge.
```

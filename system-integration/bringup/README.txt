...
LED/switch test:
  ...
  2. Add system-integration/bringup/hdl/led_switch_no_reset_top.v.
  3. Add system-integration/bringup/constraints/nexys_video_led_switch_no_reset.xdc as a constraint source.
  4. Set led_switch_no_reset_top as top.
  5. Synthesize, implement, generate bitstream, program board.

UART hello test:
  1. Create RTL project.
  2. Add system-integration/bringup/hdl/uart_tx.v.
  3. Add system-integration/bringup/hdl/uart_hello_no_reset_top.v.
  4. Add system-integration/bringup/constraints/nexys_video_uart_hello_no_reset.xdc.
...
```text
python system-integration/tools/serial_logger.py --list-ports
python system-integration/tools/serial_logger.py --port COM3 --baud 115200 --log data/bringup_uart_log.csv
```

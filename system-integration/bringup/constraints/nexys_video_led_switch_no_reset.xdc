## Nexys Video LED/switch bring-up constraints without clock/reset.
## Use this if programming works but led_switch_top shows no visible LED behavior.
## Expected top module ports: sw[7:0], led[7:0].

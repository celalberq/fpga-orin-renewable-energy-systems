Proje2: Network Monitoring Layer
================================
...
Current integrated network test:
...
Current PC/Orin-style network scripts:
...
Boundary: the current implementation is a telemetry transport and observability

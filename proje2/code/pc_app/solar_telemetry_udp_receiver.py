...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Receive proje2 UDP solar telemetry JSON.")
    ...
    parser.add_argument("--log", type=Path, default=Path("proje2/data/solar_udp_receiver_log.csv"))

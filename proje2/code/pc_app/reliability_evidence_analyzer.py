...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--proxy-log", type=Path, default=Path("proje2/data/solar_reliability_proxy_log.csv"))
    parser.add_argument("--dashboard-log", type=Path, default=Path("proje2/data/solar_live_dashboard_reliability_bridge_log.csv"))
    parser.add_argument("--out", type=Path, default=Path("proje2/data/solar_reliability_evidence_summary.txt"))

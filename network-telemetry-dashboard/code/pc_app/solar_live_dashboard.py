...
<body>
  ...
  <main>
    ...
    <section class="metrics">
      ...
      <div class="panel"><div class="label">Digital Comm Layer</div><div id="commLayer" class="value comm-value">-</div><div id="commDetail" class="detail">Waiting for fpga-digital-communications bridge metadata.</div></div>
    </section>
    ...
    async function refresh() {
      try {
        ...
        if (comm.layer) {
          ...
          text("commDetail", "No fpga-digital-communications bridge metadata in this packet.");
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Live dashboard for network-telemetry-dashboard UDP solar telemetry.")
    ...
    parser.add_argument("--log", type=Path, default=Path("network-telemetry-dashboard/data/solar_live_dashboard_log.csv"))

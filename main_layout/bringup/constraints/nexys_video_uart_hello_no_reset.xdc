## Nexys Video UART hello constraints without reset.
## Expected top module ports: clk, sw[7:0], led[7:0], uart_rx_out, uart_tx_in.
## UART pins match Digilent Nexys-Video-Master.xdc:
## Direction is from the PC/FT232R point of view:

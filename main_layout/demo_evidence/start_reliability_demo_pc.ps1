...
if (Test-Path $PidFile) {
    throw "PID file already exists: $PidFile. Run main_layout/demo_evidence/stop_reliability_demo_pc.ps1 first."
}
...
$Started += Start-DemoProcess "dashboard" @(
    "proje2/code/pc_app/solar_live_dashboard.py",
    "--udp-host", "0.0.0.0",
    ...
    "--bess-load-w", "0.1",
    "--recovery-window", "10",
    "--log", "proje2/data/solar_live_dashboard_reliability_bridge_log.csv"
)
Start-Sleep -Milliseconds 600

$Started += Start-DemoProcess "reliability_proxy" @(
    "proje2/code/pc_app/solar_reliability_proxy.py",
    "--bind-host", "0.0.0.0",
    ...
    "--corrupt-every", "9",
    "--inject-first", "30",
    "--log", "proje2/data/solar_reliability_proxy_bridge_log.csv"
)
Start-Sleep -Milliseconds 600

$Started += Start-DemoProcess "tracker_bridge" @(
    "proje1/code/pc_app/tracker_udp_comm_bridge.py",
    "--bind-host", "0.0.0.0",
    "--bind-port", "$BridgeUdpPort",
    "--forward-host", "127.0.0.1",
    "--forward-port", "$ProxyUdpPort",
    "--log", "proje1/data/tracker_udp_comm_bridge_reliability_log.csv"
)

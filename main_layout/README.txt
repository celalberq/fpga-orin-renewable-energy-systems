Main Layout: Integrated System Documentation
============================================

This folder contains the current architecture, evidence, reports, and shared
tools for the completed three-layer prototype.
...
Use these files to keep proje3, proje1, and proje2 connected through one shared
renewable telemetry/data platform, with clear Nexys Video and Orin Nano Super roles.
...
3. The PC runs the Proje1 CRC/QPSK/OFDM bridge and the Proje2 dashboard/logger.

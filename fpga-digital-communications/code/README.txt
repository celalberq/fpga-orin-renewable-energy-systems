FPGA Digital Communications Communication Code
=========================
...
The tracker simulations use the current solar-tracker-bess Orin tracker/INA226 telemetry
packet as the payload, so fpga-digital-communications now protects the same data used by network-telemetry-dashboard and
solar-tracker-bess.

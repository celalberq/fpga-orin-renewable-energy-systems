...
module qpsk_channel_model_top #(
    ...
    reg [31:0] ber_ppm_latched = 32'd0;
    reg [2:0] mode_latched = 3'd0;
    ...
    wire tx_i_positive;
    wire tx_q_positive;
    wire [7:0] noise_threshold = threshold_for_mode(mode_latched);
    wire noise_enabled = mode_latched != 3'd0;
    wire i_noise = noise_enabled && (lfsr[7:0] < noise_threshold);
    wire q_noise = noise_enabled && (lfsr[15:8] < noise_threshold);
    wire rx_i_positive = tx_i_positive ^ i_noise;
    wire rx_q_positive = tx_q_positive ^ q_noise;
    ...
    wire [31:0] ber_ppm_next = ber_ppm_for_mode(mode_latched);

    assign led[0] = last_ok;
    assign led[1] = noise_enabled;
    assign led[2] = uart_busy;
    assign led[3] = heartbeat;
    assign led[6:4] = mode_latched;
    assign led[7] = bit_error_latched != 16'd0;
    ...
    function [7:0] threshold_for_mode;
        input [2:0] mode;
        begin
            case (mode)
                3'd0: threshold_for_mode = 8'd0;
                3'd1: threshold_for_mode = 8'd4;
                3'd2: threshold_for_mode = 8'd8;
                3'd3: threshold_for_mode = 8'd16;
                3'd4: threshold_for_mode = 8'd32;
                3'd5: threshold_for_mode = 8'd48;
                3'd6: threshold_for_mode = 8'd64;
                default: threshold_for_mode = 8'd96;
            endcase
        end
    endfunction

    function [31:0] ber_ppm_for_mode;
        input [2:0] mode;
        begin
            case (mode)
                3'd0: ber_ppm_for_mode = 32'd0;
                3'd1: ber_ppm_for_mode = 32'd2873;
                3'd2: ber_ppm_for_mode = 32'd14367;
                3'd3: ber_ppm_for_mode = 32'd48850;
                3'd4: ber_ppm_for_mode = 32'd114942;
                3'd5: ber_ppm_for_mode = 32'd173850;
                3'd6: ber_ppm_for_mode = 32'd241379;
                default: ber_ppm_for_mode = 32'd372126;
            endcase
        end
    endfunction
    ...
    function [7:0] dec_digit6;
        input [31:0] value;
        input [2:0] digit_index;
        begin
            case (digit_index)
                3'd0: dec_digit6 = 8'd48 + ((value / 32'd100000) % 32'd10);
                3'd1: dec_digit6 = 8'd48 + ((value / 32'd10000) % 32'd10);
                3'd2: dec_digit6 = 8'd48 + ((value / 32'd1000) % 32'd10);
                3'd3: dec_digit6 = 8'd48 + ((value / 32'd100) % 32'd10);
                3'd4: dec_digit6 = 8'd48 + ((value / 32'd10) % 32'd10);
                3'd5: dec_digit6 = 8'd48 + (value % 32'd10);
                default: dec_digit6 = "?";
            endcase
        end
    endfunction
    ...
    function [7:0] message_char;
        ...
        begin
            case (index)
                ...
                8'd13: message_char = ",";
                8'd14: message_char = "m";
                8'd15: message_char = "o";
                8'd16: message_char = "d";
                8'd17: message_char = "e";
                8'd18: message_char = "=";
                8'd19: message_char = 8'd48 + {5'd0, mode_latched};
                8'd20: message_char = ",";
                8'd21: message_char = "s";
                8'd22: message_char = "y";
                8'd23: message_char = "m";
                8'd24: message_char = "s";
                8'd25: message_char = "=";
                8'd26: message_char = "0";
                8'd27: message_char = "0";
                8'd28: message_char = "3";
                8'd29: message_char = "4";
                8'd30: message_char = "8";
                8'd31: message_char = ",";
                8'd32: message_char = "b";
                8'd33: message_char = "i";
                8'd34: message_char = "t";
                8'd35: message_char = "s";
                8'd36: message_char = "=";
                8'd37: message_char = "0";
                8'd38: message_char = "0";
                8'd39: message_char = "6";
                8'd40: message_char = "9";
                8'd41: message_char = "6";
                8'd42: message_char = ",";
                8'd43: message_char = "s";
                8'd44: message_char = "y";
                8'd45: message_char = "m";
                8'd46: message_char = "_";
                8'd47: message_char = "e";
                8'd48: message_char = "r";
                8'd49: message_char = "r";
                8'd50: message_char = "=";
                8'd51: message_char = dec_digit5(symbol_error_latched, 3'd0);
                8'd52: message_char = dec_digit5(symbol_error_latched, 3'd1);
                8'd53: message_char = dec_digit5(symbol_error_latched, 3'd2);
                8'd54: message_char = dec_digit5(symbol_error_latched, 3'd3);
                8'd55: message_char = dec_digit5(symbol_error_latched, 3'd4);
                8'd56: message_char = ",";
                8'd57: message_char = "b";
                8'd58: message_char = "i";
                8'd59: message_char = "t";
                8'd60: message_char = "_";
                8'd61: message_char = "e";
                8'd62: message_char = "r";
                8'd63: message_char = "r";
                8'd64: message_char = "=";
                8'd65: message_char = dec_digit5(bit_error_latched, 3'd0);
                8'd66: message_char = dec_digit5(bit_error_latched, 3'd1);
                8'd67: message_char = dec_digit5(bit_error_latched, 3'd2);
                8'd68: message_char = dec_digit5(bit_error_latched, 3'd3);
                8'd69: message_char = dec_digit5(bit_error_latched, 3'd4);
                8'd70: message_char = ",";
                8'd71: message_char = "b";
                8'd72: message_char = "e";
                8'd73: message_char = "r";
                8'd74: message_char = "=";
                8'd75: message_char = dec_digit6(ber_ppm_latched, 3'd0);
                8'd76: message_char = dec_digit6(ber_ppm_latched, 3'd1);
                8'd77: message_char = dec_digit6(ber_ppm_latched, 3'd2);
                8'd78: message_char = dec_digit6(ber_ppm_latched, 3'd3);
                8'd79: message_char = dec_digit6(ber_ppm_latched, 3'd4);
                8'd80: message_char = dec_digit6(ber_ppm_latched, 3'd5);
                8'd81: message_char = ",";
                8'd82: message_char = "o";
                8'd83: message_char = "k";
                8'd84: message_char = "=";
                8'd85: message_char = last_ok ? "1" : "0";
                8'd86: message_char = 8'h0D;
                8'd87: message_char = 8'h0A;
        ...
        case (state)
            ...
            ST_RUN: begin
                ...
                if (symbol_index == SYMBOL_LAST_INDEX) begin
                    ...
                    ber_ppm_latched <= ber_ppm_next;
                    last_ok <= bit_error_next == 16'd0;
                    heartbeat <= ~heartbeat;
                    message_index <= 8'd0;
                    state <= ST_SEND;
                end else begin
